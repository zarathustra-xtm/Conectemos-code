...
$sql = "SELECT chatid,ayu_id,sender_userid,message,reciever_userid,timestamp from ".$tutu."_chat where ayu_id like '".htmlspecialchars($_GET['khat'])."' order by chatid asc limit 30";
...
<?php            
	...
	?>   
<?php    
//$sql = "UPDATE ".$tutu."_chat2 SET status='1' WHERE ayu_id = '".htmlspecialchars($_GET['khat'])."' and status = '0'";
