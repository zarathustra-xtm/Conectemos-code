	...
	<div class="row">
        <div class="col-md-3">
            <form name="add" method="post" action="?enc=_4">
              <div class="form-group">
                <label for="exampleInputEmail1">Agregar Candidato a Presidente</label>
              </div>                 
                <input type="text" class="form-control" name="n_pre" id="n_pre" placeholder="Nombre y Apellido">
                <br>
              <div class="form-group">
                <label for="exampleInputEmail1">Pertenece al Partido :</label>
              </div>                 
        <select class="form-control" id="aaaaaa" name="par_pre">
                    <?php                                    
            ...
            <form action="#" method="get">
                ...
                <?php
                    if( isset($_POST['n_pre']) )
                         { 
                         $add = "INSERT INTO ".$tutu."_pre (n_pre,par_pre) VALUES ('$_POST[n_pre]','$_POST[par_pre]')";
