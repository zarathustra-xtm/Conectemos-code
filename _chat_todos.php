...
<?php 
$sql = "SELECT chatid,ayu_id,sender_userid,message,reciever_userid,timestamp from ".$tutu."_chat where sender_userid like '".htmlspecialchars($_GET['env'])."' or reciever_userid like '".htmlspecialchars($_GET['env'])."' and ayu_id like '".htmlspecialchars($_GET['khat'])."' order by chatid asc limit 30";
...
<?php            
	...
	?>   
<?php    
//$sql = "UPDATE ".$tutu."_chat SET status='1' WHERE ayu_id = '".htmlspecialchars($_GET['khat'])."' and status = '0'";
