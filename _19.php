...
<?php
    if( isset($_POST['roo']) )
         { 
            $sql = "UPDATE ".$tutu."_susu SET name='$_POST[name]',email='$_POST[email]',status='$_POST[status]',social_id='$_POST[social_id]' WHERE user_id like '".htmlspecialchars($_GET['us'])."' ";
                                                        ...
                                                        <div id="user" class="tab-pane">
                                                            <div class="row">
                                                                <div class="col-lx-12  center">
                                                                       <?php 
                                                                            $sql = "SELECT user_id,name,email,status,social_id FROM ".$tutu."_susu where email like '".$row['ema_org']."' and roola like 'orga' ";
                                                                                ...
                                                                                if ($rowa['status'] == '1'){
                                                                                 ...
                                                                                 <h4 class="blue">
                                                                                    ...
                                                                                    <form method="post" action="?enc=_19&org=<?php echo htmlspecialchars($_GET['org']) ; ?>&us=<?php echo $rowa['user_id'];?>" class="form-register" role="form" id="register-form">
                                                                                        ...
                                                                                        <div> Categor&iacute;a :&nbsp;&nbsp;
                                                                                          <select name="social_id">
                                                                                            <?php if($rowa['social_id'] == 'dinero' ) {?>
                                                                                               <option value="dinero" selected>dinero</option>
                                                                                           <?php } else {  ?>
                                                                                               <option value="dinero" >dinero</option>    
                                                                                           <?php }  ?>
                                                                                            <?php if($rowa['social_id'] == 'tiempo' ) {?>
                                                                                               <option value="tiempo" selected>dinero</option>
                                                                                           <?php } else {  ?>
                                                                                               <option value="tiempo" >tiempo</option>    
                                                                                           <?php }  ?>                                                                                     <?php if($rowa['social_id'] == 'recurso' ) {?>
                                                                                               <option value="recurso" selected>dinero</option>
                                                                                           <?php } else {  ?>
                                                                                               <option value="recurso" >recurso</option>    
                                                                                           <?php }  ?>                                                                                     <?php if($rowa['social_id'] == '' ) {?>
                                                                                               <option value="sin_catego" selected>Sin Catego</option>
                                                                                           <?php } else {  ?>
                                                                                               <option value="sin_catego" >Sin Catego</option>    
                                                                                           <?php }  ?>                                                          
                                                                                          </select>           
                                                                                        </div>
                                                                                        <div> Activo :&nbsp;&nbsp;
