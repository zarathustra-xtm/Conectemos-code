...
class Cl_Usero
{
	...
	public function registration( array $data )
	{
		if( !empty( $data ) ){
            ...
            $querya = "INSERT INTO enla_org (n_org,pais_org,dep_org,mun_org,tip_org,aded_org,obge_org,act_org,bene_org,cuabe_org,descu_org,inter_org,cuape_org,sede_org,fuein_org,deacu_org,don_org,con_org,tel_org,ema_org,apo_org) VALUES ('$name','GT','Guatemala', 'Guatemala','12','-','0','-','0','0','$feca','SI','0','NO','1','SI','SI','$name','-','$email','-' )";
                    if(mysqli_query($this->_con, $querya)){
  ...
  //                  $cabeceras .= 'Bcc: ormaprime@gmail.com' . "\r\n";
	...
	public function login( array $data )
	{
		...
		if( !empty( $data ) ){
			...
			$password = md5( $password );
			$query = "SELECT user_id, name, email, roola, status, created FROM enla_susu where email = '$email' and password = '$password' and status = '1'";
